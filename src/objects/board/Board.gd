...
onready var CornerCardBody = preload("res://src/objects/card/CornerCardBody.tscn")
onready var CardBody = preload("res://src/objects/card/CardBody.tscn")
onready var View = preload("res://src/objects/viewport/View.tscn")
